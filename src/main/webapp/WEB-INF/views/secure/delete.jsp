...
<div class="container-fluid">
    ...
    <form method="post" action="/secure/deleteoperation">
        <div class="container" style="margin-top: 100px; margin-bottom: 100px">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center; font-weight: bold "><spring:message code="label.deleteProduct"/></div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <table class="table  table-bordered" style="margin-top: 5px;" >
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><spring:message code="label.bookId" var="bookId"/>${bookId}</label>
                                ...
                                <div class="form-group last" style="margin-top: 15px">
                                    <div class="col-md-12" style="margin-top: 15px; margin-bottom: 15px; text-align:center;" >
                                        ...
                                        <button type="submit" name="give" id="give" class="btn btn-success"><spring:message code="label.checkAndDelete"/></button>
                                    </div>
                                </div>
                            </table>
                            <%--</div>--%>
