...
<div class="container-fluid">
    ...
    <form method="post" action="/secure/giveoperation" id="giveFrom" name="giveForm">
        <div class="container" style="margin-top: 100px; margin-bottom: 100px">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center; font-weight: bold "><spring:message code="label.giveProduct"/></div>
                                ...
                                <table class="table  table-bordered" style="margin-top: 5px;" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="margin-bottom: 5px">
                                            <input type="number" id="bookId" name="bookId" class="form-control" placeholder="${bookId}"   />
                                        </div>
                                    ...
                                    <div class="form-group last" style="margin-top: 15px">
                                        <div class="col-md-12" style="margin-top: 15px; margin-bottom: 15px; text-align:center;" >
                                            ...
                                            <button type="submit" name="give" id="give" class="btn btn-success"><spring:message code="label.check_give"/></button>
                                        </div>
                                    </div>
                                </table>
                            <%--</div>--%>
